  ...
  return (
    <html lang="zh-TW" data-theme="light">
      ...
      <body>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){const toggle=document.getElementById('theme-toggle'),currentTheme=localStorage.getItem('theme')||'light';toggle.checked=currentTheme==='dark';toggle.addEventListener('change',function(){const newTheme=this.checked?'dark':'light';document.documentElement.setAttribute('data-theme',newTheme);localStorage.setItem('theme',newTheme);});})();`,
          }}
        />
      </body>
    </html>
